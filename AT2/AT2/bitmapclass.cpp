...
bool BitmapClass::Initialise(ID3D11Device* device, ID3D11DeviceContext* deviceContext, int screenWidth, int screenHeight, char* textureFilename, int bitmapWidth, int bitmapHeight)
{
	bool result;
...
bool BitmapClass::InitialiseBuffers(ID3D11Device* device)
{
	VertexType* vertices;
