...
RenderTextureClass::RenderTextureClass(RenderTextureClass& other)
{
}
...
bool RenderTextureClass::Initialise(ID3D11Device* device, int textureWidth, int textureHeight, float screenDepth, float screenNear)
{
	...
	m_projectionMatrix = XMMatrixPerspectiveFovLH(((float)3.1415 / 4.0f), ((float)textureWidth / (float)textureHeight), screenNear, screenDepth);
