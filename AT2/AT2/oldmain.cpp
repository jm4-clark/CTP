...
//double GetFrameTime();
//
//bool LoadObjModel(std::wstring filename, ID3D11Buffer** vertBuff, ID3D11Buffer** indexBuff,
...
//
//	//Use the shader resource representing the direct2d render target to texture a square which is rendered in screen space so it
//	//overlays on top of our entire scene. We use alpha blending so that the entire background of the D2D render target is "invisible",
