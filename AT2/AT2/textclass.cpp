...
bool TextClass::Initialise(ID3D11Device* device, ID3D11DeviceContext* deviceContext, HWND hwnd, int screenWidth, int screenHeight, XMMATRIX baseViewMatrix)
{
	bool result;
	...
	result = m_font->Initialise(device, deviceContext, "../AT2/Resources/fontdata.txt", "../AT2/Resources/font.tga");
	if (!result)
	{
...
bool TextClass::InitialiseSentence(SentenceType** sentence, int maxLength, ID3D11Device* device)
{
	VertexType* vertices;
