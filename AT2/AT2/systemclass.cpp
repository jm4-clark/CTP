...
bool SystemClass::Frame()
{
	...
	camPos = m_graphics->GetCamPos();
	camRot = m_graphics->GetCamRot();
	...
	result = m_graphics->Frame(m_fps->GetFps(), m_cpu->GetCpuPercentage(), m_timer->GetTime(), camPos, camRot);
	if (!result)
	{
		return false;
	}
